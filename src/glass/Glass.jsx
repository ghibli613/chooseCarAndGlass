...
export default class Glass extends Component {
    ...
    render() {
        ...
        return (
            <div style={{backgroundImage: `url("./glassesImage/background.jpg")`, backgroundSize: '100% 100%', backgroundRepeat: 'no-repeat'}}>
                <div className="header" style={{backgroundColor: 'rgba(0, 0, 0, 0.7)', color: 'white', paddingTop: '20px', paddingBottom: '20px'}}>
                    TRY GLASS APP ONLINE
                </div>
                <div className='body' style={{backgroundColor: 'rgba(60, 60, 60, 0.7)', paddingBottom: '20px'}}>
                    <div className="container">
                        <div className="row" style={{paddingTop: '50px', paddingBottom: "50px"}}>
                            <div className="col-6">
                                <div style={{backgroundImage: `url("./glassesImage/model.jpg")`, backgroundSize: 'cover', width:'50%', height:'90%', display: 'inline-block'}}>
                                    <img src={`${glassList[index].url}`} width='60%' style={{marginTop: '85px', marginBottom: '75px'}}/>
                                    <div style={{backgroundColor: 'rgba(255, 153, 0, 0.7)', height: '28.5%'}}>
                                        <div style={{textAlign: 'left', color: 'blue', marginLeft: '2px'}}>
                                            {glassList[index].name}
                                        </div>
                                        <div style={{textAlign: 'left', color: 'white', marginLeft: '2px', fontSize: '13px'}}>
